...
import POexpansionTemplate from "./POexpansionTemplate";
...
const PomsBooking = ({
  ...
  console.log(OrderNo_)
  const orderDate_ = getUniqueOptions(data, "orderDate");
  ...
  const onOrderClick = (rowData) => {
    setExpandedRow(expandedRow?.orderNo === rowData.orderNo ? null : rowData);
  };
...
const rowExpansionTemplate = (rowData) => {
  console.log(rowData)
  return (
    <POexpansionTemplate filterData={rowData.products} />
