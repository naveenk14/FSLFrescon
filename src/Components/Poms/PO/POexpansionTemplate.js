...
//   }, [filterValue, filterMonthValue]);
  ...
  const product_ = getUniqueOptions(data, "product");
  const productCode_ = getUniqueOptions(data, "productCode");
  const productName_ = getUniqueOptions(data, "productName");
      ...
      >
        <Column
          ...
          header={
            ...
            >
              Product
              {MultiSelectFilter("product", product_, tblFilter.product, "Product")}
              {sort("product")}
            </span>
          }
          body={productTemplateFilterData}
        ...
        <Column
          ...
          header={
            ...
            >
              Product Name
              {MultiSelectFilter("productName", productName_, tblFilter.productName, "Product Name")}
              {sort("productName")}
            </span>
          }
...
export default POexpansionTemplate;